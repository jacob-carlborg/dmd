...
extern (C++) abstract class Expression : RootObject
{
    ...
    final extern (D) this(this T)(Loc loc, TOK op)
    {
        pragma(msg, T);
        //printf("Expression::Expression(op = %d) this = %p\n", op, this);
        this.loc = loc;
        this.op = op;
        this.size = cast(ubyte) __traits(classInstanceSize, T);
    }
...
extern (C++) final class AssocArrayLiteralExp : Expression
{
    ...
    {
        super(loc, TOK.assocArrayLiteral);
...
extern (C++) final class NewAnonClassExp : Expression
{
    ...
    {
        super(loc, TOK.newAnonymousClass);
        this.thisexp = thisexp;
        this.newargs = newargs;
        this.cd = cd;
        this.arguments = arguments;
...
extern (C++) class SymbolExp : Expression
{
    ...
    final extern (D) this(Loc loc, TOK op, Declaration var, bool hasOverloads)
    {
        super(loc, op);
        assert(var);
        this.var = var;
...
extern (C++) final class SymOffExp : SymbolExp
{
    ...
    extern (D) this(Loc loc, Declaration var, dinteger_t offset, bool hasOverloads = true)
    {
        ...
        super(loc, TOK.symbolOffset, var, hasOverloads);
        this.offset = offset;
    }
...
extern (C++) final class VarExp : SymbolExp
{
    extern (D) this(Loc loc, Declaration var, bool hasOverloads = true)
    {
        ...
        super(loc, TOK.variable, var, hasOverloads);
...
extern (C++) class UnaExp : Expression
{
    ...
    final extern (D) this(Loc loc, TOK op, Expression e1)
    {
        super(loc, op);
        this.e1 = e1;
    }
...
extern (C++) abstract class BinExp : Expression
{
    ...
    final extern (D) this(Loc loc, TOK op, Expression e1, Expression e2)
    {
        super(loc, op);
        this.e1 = e1;
        this.e2 = e2;
...
extern (C++) final class DotTemplateExp : UnaExp
{
    ...
    {
        super(loc, TOK.dotTemplateDeclaration, e);
        this.td = td;
    }
...
extern (C++) final class DotTemplateInstanceExp : UnaExp
{
    ...
    {
        super(loc, TOK.dotTemplateInstance, e);
...
extern (C++) final class DelegatePtrExp : UnaExp
{
    extern (D) this(Loc loc, Expression e1)
    {
        super(loc, TOK.delegatePointer, e1);
    }
...
extern (C++) final class DelegateFuncptrExp : UnaExp
{
    extern (D) this(Loc loc, Expression e1)
    {
        super(loc, TOK.delegateFunctionPointer, e1);
    }
...
extern (C++) final class PostExp : BinExp
{
    ...
    {
        super(loc, op, e, new IntegerExp(loc, 1, Type.tint32));
    }
...
extern (C++) final class ShlAssignExp : BinAssignExp
{
    extern (D) this(Loc loc, Expression e1, Expression e2)
    {
        super(loc, TOK.leftShiftAssign, e1, e2);
    }
...
extern (C++) final class ShrAssignExp : BinAssignExp
{
    extern (D) this(Loc loc, Expression e1, Expression e2)
    {
        super(loc, TOK.rightShiftAssign, e1, e2);
    }
...
extern (C++) final class UshrAssignExp : BinAssignExp
{
    extern (D) this(Loc loc, Expression e1, Expression e2)
    {
        super(loc, TOK.unsignedRightShiftAssign, e1, e2);
    }
...
extern (C++) final class CatAssignExp : BinAssignExp
{
    extern (D) this(Loc loc, Expression e1, Expression e2)
    {
        super(loc, TOK.concatenateAssign, e1, e2);
    }
...
extern (C++) final class CatExp : BinExp
{
    extern (D) this(Loc loc, Expression e1, Expression e2)
    {
        super(loc, TOK.concatenate, e1, e2);
    }
...
extern (C++) final class ShrExp : BinExp
{
    extern (D) this(Loc loc, Expression e1, Expression e2)
    {
        super(loc, TOK.rightShift, e1, e2);
    }
...
extern (C++) final class UshrExp : BinExp
{
    extern (D) this(Loc loc, Expression e1, Expression e2)
    {
        super(loc, TOK.unsignedRightShift, e1, e2);
    }
...
extern (C++) class DefaultInitExp : Expression
{
    ...
    final extern (D) this(this T)(Loc loc, TOK subop)
    {
        super.__ctor(T)(loc, TOK.default_);
        // super!(T)(loc, TOK.default_);
        this.subop = subop;
    }
